...
export const videoModules: Module[] = [
  ...
  },
  {
    ...
    icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-purple-500"><path stroke-linecap="round" stroke-linejoin="round" d="M12.75 8.25v7.5M8.25 12h7.5m6.75-3c0 7.459-6.041 13.5-13.5 13.5S1.5 19.459 1.5 12 7.541 1.5 15 1.5s13.5 6.041 13.5 13.5Z" /></svg>'
  },
  {
    slug: 'speed-changer',
    title: 'Speed Changer Pro',
    description: 'Adjust video playback speed while preserving audio pitch for natural-sounding results.',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-green-500"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8.25V18a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 18V8.25m-18 0V6a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 6v2.25m-18 0h18M5.25 6h.008v.008H5.25V6zM7.5 6h.008v.008H7.5V6zm2.25 0h.008v.008h-.008V6z" /></svg>'
  },
  {
