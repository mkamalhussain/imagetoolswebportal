...
export const metadata: Metadata = {
  title: "All Tools",
  description:
    "Browse our complete collection of 50+ free online tools for image editing, audio processing, video editing, and PDF manipulation. No signup required, privacy-first approach.",
  keywords: [
    "all online tools",
  ...
  openGraph: {
    ...
    description:
      "Browse 50+ free online tools for creative work. Image editing, audio processing, video editing, PDF tools, and more.",
    images: [
      {
